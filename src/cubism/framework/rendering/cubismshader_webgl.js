...
import { embeddedShaders } from './cubismshader_sources';
// Shader
...
export class CubismShader_WebGL {
    /**
     * 埋め込み済みのシェーダーソースを読み込む
     */
    loadShaders() {
        return __awaiter(this, void 0, void 0, function* () {
            this._vertShaderSrc = embeddedShaders[VertShaderSrcPath];
            this._vertShaderSrcMasked = embeddedShaders[VertShaderSrcMaskedPath];
            this._vertShaderSrcSetupMask =
                embeddedShaders[VertShaderSrcSetupMaskPath];
            this._fragShaderSrcSetupMask =
                embeddedShaders[FragShaderSrcSetupMaskPath];
            this._fragShaderSrcPremultipliedAlpha =
                embeddedShaders[FragShaderSrcPremultipliedAlphaPath];
            this._fragShaderSrcMaskPremultipliedAlpha =
                embeddedShaders[FragShaderSrcMaskPremultipliedAlphaPath];
            this._fragShaderSrcMaskInvertedPremultipliedAlpha =
                embeddedShaders[FragShaderSrcMaskInvertedPremultipliedAlphaPath];
            this._vertShaderSrcCopy = embeddedShaders[VertShaderSrcCopyPath];
            this._fragShaderSrcCopy = embeddedShaders[FragShaderSrcCopyPath];
            this._fragShaderSrcColorBlend =
                embeddedShaders[FragShaderSrcColorBlendPath];
            this._fragShaderSrcAlphaBlend =
                embeddedShaders[FragShaderSrcAlphaBlendPath];
            this._vertShaderSrcBlend = embeddedShaders[VertShaderSrcBlendPath];
            this._fragShaderSrcBlend = embeddedShaders[FragShaderSrcBlendPath];
        });
    }
    /**
     * コンストラクタ
